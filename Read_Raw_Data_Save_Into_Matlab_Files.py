...
os.chdir(
    "/content/EEG-Motor-Imagery-Classification-CNNs-TensorFlow/PhysioNet_MI_Dataset"
)
SAVE = "/content/EEG-Motor-Imagery-Classification-CNNs-TensorFlow/Saved_Matlab_Data/"
...
def projection_2d(loc):
    ...
    return np.stack(
        (np.multiply(rho, np.cos(theta)), np.multiply(rho, np.sin(theta))), 1
    )
...
def load_raw_data(electrodes, subject=None, num_classes=4, long_edge=False):
    ...
    for subject_id in subject_ids:
        try:
            t, l, loc, fs = load_physionet_data(
                subject_id, num_classes, long_edge=long_edge
            )
    ...
    return np.array(trials, dtype=np.float64).reshape(
        (len(trials),) + trials[0].shape + (1,)
...
electrodes = [8]
subject = range(1, 106)
X_105_C5, y_105_C5 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [9]
subject = range(1, 106)
X_105_C3, y_105_C3 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [10]
subject = range(1, 106)
X_105_C1, y_105_C1 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [12]
subject = range(1, 106)
X_105_C2, y_105_C2 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [13]
subject = range(1, 106)
X_105_C4, y_105_C4 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [14]
subject = range(1, 106)
X_105_C6, y_105_C6 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [15]
subject = range(1, 106)
X_105_CP5, y_105_CP5 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [16]
subject = range(1, 106)
X_105_CP3, y_105_CP3 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [17]
subject = range(1, 106)
X_105_CP1, y_105_CP1 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [19]
subject = range(1, 106)
X_105_CP2, y_105_CP2 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [20]
subject = range(1, 106)
X_105_CP4, y_105_CP4 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [21]
subject = range(1, 106)
X_105_CP6, y_105_CP6 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [48]
subject = range(1, 106)
X_105_P5, y_105_P5 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [49]
subject = range(1, 106)
X_105_P3, y_105_P3 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [50]
subject = range(1, 106)
X_105_P1, y_105_P1 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [52]
subject = range(1, 106)
X_105_P2, y_105_P2 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
...
electrodes = [53]
subject = range(1, 106)
X_105_P4, y_105_P4 = load_raw_data(
    electrodes=electrodes, subject=subject, num_classes=nclasses
)
